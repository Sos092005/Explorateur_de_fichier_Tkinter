...
class IconManager:
    ...
    ICON_PATHS = {
        ...
        'sort_asc': 'assets/sort_asc.png',
        'sort_desc': 'assets/sort_desc.png',
        ...
        'powerpoint': 'assets/powerpoint.png',
    ...
    def get_file_icon(self, path):
        ...
        if os.path.isdir(path):
            print(f"Getting folder icon for {path}")
            return self.get_icon('folder')
    
        ext = os.path.splitext(path)[1].lower().lstrip('.')
        print(f"Getting icon for {path} with extension {ext}")
